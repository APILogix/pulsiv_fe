    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div className="flex items-center gap-2">
        <input
          type="checkbox"
          id="remember"
          className="h-3.5 w-3.5 rounded border-[#333333] bg-[#161616] accent-[#34d399] cursor-pointer"
        />
        <label htmlFor="remember" className="text-xs text-[#999999] cursor-pointer select-none">
