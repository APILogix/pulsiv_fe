    ...
    <div className="w-full">
      ...
      <div className="flex flex-col gap-3 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-2.5 bg-transparent text-foreground border border-border text-[14px] font-medium p-3 rounded-lg hover:bg-white/5 hover:border-border transition-all disabled:opacity-60"
        >
      ...
      <div className="flex items-center text-center mb-6">
        ...
        <span className="px-3 text-muted-foreground text-[11px] font-semibold uppercase tracking-[0.05em]">
      ...
      <div className="text-center mt-8 text-[13px] text-muted-foreground">
