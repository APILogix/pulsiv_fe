...
export const mainNavigation: MainNavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Profile", path: "/admin", icon: Building2, status: "live", exact: true, description: "Organization identity, ownership, and base settings.", group: "General" },
      { label: "Settings", path: "/admin/settings", icon: Settings, status: "live", description: "Security, session, retention, and data-region controls.", group: "General" },
      { label: "Operations", path: "/admin/admin-ops", icon: Wrench, status: "live", description: "Privileged sync and configuration tools.", group: "General" },
      ...
      { label: "Teams", path: "/admin/teams", icon: UserCheck, status: "coming-soon", description: "Functional team organization and rotation rules.", group: "Access" },
  ...
  },
  {
    ...
    children: [
      { label: 'Project API keys', path: '/projects', icon: KeyRound, status: "live", description: "Select a project to manage its supported ingestion API keys.", group: "SDK Settings" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Linked accounts', path: '/settings/linked-accounts', icon: Link2, status: "live", description: "Manage social accounts linked to your profile.", group: "Personal" },
      { label: 'Email verification', path: '/settings/email-verification', icon: MailCheck, status: "live", description: "Review and complete email verification.", group: "Personal" },
      { label: 'Authentication policy', path: '/settings/authentication-policy', icon: ShieldCheck, status: "live", description: "Review the effective security policy for your account.", group: "Personal" },
