  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col gap-3 mb-6">
        <button className="w-full flex items-center justify-center gap-2.5 bg-transparent text-white border border-[#1f1f1f] text-[14px] font-medium p-3 rounded-lg hover:bg-white/5 hover:border-[#2a2a2a] transition-all">
        ...
        <button className="w-full flex items-center justify-center gap-2.5 bg-transparent text-white border border-[#1f1f1f] text-[14px] font-medium p-3 rounded-lg hover:bg-white/5 hover:border-[#2a2a2a] transition-all">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-[18px] h-[18px]"><path d="M22 12a10.06 10.06 0 0 0-1.5-5.5L12 12l8 8a10.06 10.06 0 0 0 2-8z"></path><path d="M12 2v10l-8 8A10.06 10.06 0 0 1 2 12a10.06 10.06 0 0 1 1.5-5.5L12 12z"></path></svg>
          Sign up with Google
        </button>
      </div>
