...
export default function LogsPage() {
  ...
  const columns: Column<LogEvent>[] = [
    ...
    { key: "env", header: "Environment", width: "120px", cell: (l) => <EnvironmentBadge environment={l.metadata.environment} /> },
    { key: "ai", header: "", width: "90px", cell: (l) => <AskAiButton question={`Explain this log message and its likely cause: "${l.message}" (service ${l.metadata.service}).`} /> },
  ];
