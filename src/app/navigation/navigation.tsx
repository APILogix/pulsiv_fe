...
export const mainNavigation: MainNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Executive command center", path: "/dashboards/executive", icon: LayoutDashboard, status: "live", description: "Single-pane portfolio health: score, errors, latency, revenue at risk." },
      { label: "Performance deep dive", path: "/dashboards/performance", icon: LineChart, status: "live", description: "Latency percentiles, dependency latency, slow requests, cold starts." },
      { label: "Error triage", path: "/dashboards/errors", icon: AlertTriangle, status: "live", description: "Grouped errors, regressions, mechanism breakdown, service impact." },
      ...
      { label: "Real-time traffic", path: "/dashboards/realtime", icon: Radar, status: "live", description: "Live RPS, status codes, connections, top routes, live stream." },
      { label: "Tracing & dependency map", path: "/dashboards/tracing", icon: ListTree, status: "live", description: "Trace list, service graph, DB query and external-call latency." },
      { label: "Infrastructure & cost", path: "/dashboards/infrastructure", icon: Database, status: "live", description: "Cost/1M requests, utilization, pools, cache, queues, storage." },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Quota requests", path: "/admin/quota-requests", icon: Gauge, status: "live", description: "Quota request review and approvals.", group: "Access" },
      ...
      { label: "Security events", path: "/admin/security-events", icon: ShieldAlert, status: "live", description: "Security event review for the org.", group: "Security" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Data retention', path: '/developer/data-retention', icon: Database, status: "live", description: "Configure how long data is retained.", group: "SDK Settings" },
      { label: 'Remote config', path: '/developer/remote-config', icon: Cable, status: "coming-soon", description: "Manage remote SDK configurations.", group: "SDK Settings" },
      { label: 'Custom settings', path: '/developer/custom-settings', icon: Settings, status: "coming-soon", description: "Manage custom SDK settings.", group: "SDK Settings" },
    ],
  },
  {
    label: "My Account",
