...
export const authApi = {
  ...
  requestEmailChange: (d: s.EmailChangeRequestFormData) => apiClient.post('/auth/email/change/request', d),
  confirmEmailChange: (d: s.EmailChangeConfirmFormData) => apiClient.post('/auth/email/change/confirm', d),
  ...
  listIdentityProviders: () => apiClient.get('/auth/identity-providers').then(r => r.data.data),
  startIdentityLink: (provider: string) => apiClient.post(`/auth/identity-providers/${provider}/link`).then(r => r.data.data),
  unlinkIdentity: (id: string) => apiClient.delete(`/auth/identity-providers/${id}`),
